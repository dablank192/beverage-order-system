        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyOrderNumber = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemsTopping", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderItemsTopping_OrderItems_OrderItemsId",
                        column: x => x.OrderItemsId,
                        principalTable: "OrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItemsTopping_Topping_ToppingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemsTopping_OrderItemsId",
                table: "OrderItemsTopping",
                column: "OrderItemsId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItemsTopping_ToppingId",
                table: "OrderItemsTopping",
                column: "ToppingId");
